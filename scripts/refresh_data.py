...
ADAPTERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        'retailer_name': 'Quiksilver', 'retailer_domain': 'quiksilver.com', 'brand': 'Quiksilver',
        'listing_urls': ['https://quiksilver.com/collections/boys'], 'age_range': 'boys',
    ...
    },
    {
        ...
        'retailer_name': 'Billabong', 'retailer_domain': 'billabong.com', 'brand': 'Billabong',
        'listing_urls': ['https://billabong.com/collections/kids-boys'], 'age_range': 'kids-boys',
    ...
    },
    {
        ...
        'retailer_name': 'Hurley', 'retailer_domain': 'hurley.com', 'brand': 'Hurley',
        'listing_urls': ['https://hurley.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids surf beach streetwear boardshorts tees hoodies accessories',
        'style_tags': ['surf', 'beach', 'streetwear'], 'source_type': 'official_brand', 'enabled': True,
    },
    {
        'name': 'volcom_kids', 'display_name': 'Volcom', 'group': 'surf_skate_official',
        'retailer_name': 'Volcom', 'retailer_domain': 'volcom.com', 'brand': 'Volcom',
        'listing_urls': ['https://volcom.com/collections/kids'], 'age_range': 'kids',
    ...
    },
    {
        ...
        'retailer_name': 'Blackcraft', 'retailer_domain': 'blackcraftcult.com', 'brand': 'Blackcraft',
        'listing_urls': ['https://blackcraftcult.com/collections/kids'], 'age_range': 'kids',
    ...
    {
        'name': 'brixton_kids', 'display_name': 'Brixton', 'group': 'surf_skate_official',
        'retailer_name': 'Brixton', 'retailer_domain': 'brixton.com', 'brand': 'Brixton',
        'listing_urls': ['https://brixton.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids surf skate streetwear tees hoodies jackets hats',
        'style_tags': ['surf', 'skate', 'streetwear'], 'source_type': 'official_brand', 'enabled': True,
    },
    {
        'name': 'kreepsville_kids', 'display_name': 'Kreepsville 666', 'group': 'alt_punk_official',
        'retailer_name': 'Kreepsville 666', 'retailer_domain': 'store.kreepsville666.com', 'brand': 'Kreepsville 666',
        'listing_urls': ['https://store.kreepsville666.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids punk goth horror alternative accessories streetwear',
        'style_tags': ['punk', 'goth', 'alt', 'graphic'], 'source_type': 'alt_brand', 'enabled': True,
    },
    {
        'name': 'tukshoes_kids', 'display_name': 'T.U.K. Shoes', 'group': 'alt_punk_official',
        'retailer_name': 'T.U.K. Shoes', 'retailer_domain': 'tukshoes.com', 'brand': 'T.U.K. Shoes',
        'listing_urls': ['https://tukshoes.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids punk goth alternative shoes creepers mary jane sneakers',
        'style_tags': ['punk', 'goth', 'alt', 'streetwear'], 'source_type': 'alt_brand', 'enabled': True,
    },
    {
        'name': 'blaspheme_boutique_kids', 'display_name': 'Blaspheme Boutique', 'group': 'alt_punk_official',
        'retailer_name': 'Blaspheme Boutique', 'retailer_domain': 'blasphemeboutique.com', 'brand': 'Blaspheme Boutique',
        'listing_urls': ['https://blasphemeboutique.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids punk goth alternative boutique dresses tees accessories',
        'style_tags': ['punk', 'goth', 'alt'], 'source_type': 'alt_brand', 'enabled': True,
    },
    {
        'name': 'hellbunny_kids', 'display_name': 'Hell Bunny', 'group': 'alt_punk_official',
        'retailer_name': 'Hell Bunny', 'retailer_domain': 'hellbunny.com', 'brand': 'Hell Bunny',
        'listing_urls': ['https://hellbunny.com/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids punk goth alternative dresses skirts tops accessories',
        'style_tags': ['punk', 'goth', 'alt', 'rockabilly'], 'source_type': 'alt_brand', 'enabled': True,
    },
    {
        'name': 'disturbia_kids', 'display_name': 'Disturbia', 'group': 'alt_punk_official',
        'retailer_name': 'Disturbia', 'retailer_domain': 'disturbia.us', 'brand': 'Disturbia',
        'listing_urls': ['https://disturbia.us/collections/kids'], 'age_range': 'kids',
        'category_context': 'kids punk goth alternative graphic streetwear',
        'style_tags': ['punk', 'goth', 'alt', 'graphic'], 'source_type': 'alt_brand', 'enabled': True,
    },
    {
